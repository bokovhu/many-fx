...
void print_usage() {
    printf("Usage: simple-delay <input.wav> <output.wav> [options]\n\n");
    printf("Adds a simple delay to the audio signal\n\n");
    printf("Options:\n");
    printf("  -h, --help, -?, --?  Show this help message and exit\n");
    printf("  --delay <float> - The delay in seconds | default: 0.0\n");
    printf("  --amp <float> - The amplitude of the delayed signal | default: 0.0\n");
}
...
int main(
    ...
    simple_delay_params_t fx_params;
    int parse_result = manyfx_parse_simple_delay_params(
        argc,
        argv,
        &fx_params
    );
