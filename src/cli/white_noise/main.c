...
void print_usage() {
    printf("Usage: white-noise <input.wav> <output.wav> [options]\n\n");
    printf("Mixes the audio signal with a random white noise\n\n");
    printf("Options:\n");
    printf("  -h, --help, -?, --?  Show this help message and exit\n");
    printf("  --mix <float> - The mix factor | default: 0.0\n");
}
...
int main(
    ...
    white_noise_params_t fx_params;
    int parse_result = manyfx_parse_white_noise_params(
        argc,
        argv,
        &fx_params
    );
