...
void print_usage() {
    printf("Usage: sin <input.wav> <output.wav> [options]\n\n");
    printf("Mixes the audio signal with a sine wave\n\n");
    printf("Options:\n");
    printf("  -h, --help, -?, --?  Show this help message and exit\n");
    printf("  --freq <float> - The frequency of the sine wave | default: 0.0\n");
    printf("  --amp <float> - The amplitude of the sine wave | default: 0.0\n");
}
...
int main(
    ...
    sin_params_t fx_params;
    int parse_result = manyfx_parse_sin_params(
        argc,
        argv,
        &fx_params
    );
