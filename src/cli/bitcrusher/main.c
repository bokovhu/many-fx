...
void print_usage() {
    printf("Usage: bitcrusher <input.wav> <output.wav> [options]\n\n");
    printf("Reduces the bit depth of the audio signal\n\n");
    printf("Options:\n");
    printf("  -h, --help, -?, --?  Show this help message and exit\n");
    printf("  --bits <int> - The number of bits to use (1-16) | default: 0\n");
}
...
int main(
    ...
    bitcrusher_params_t fx_params;
    int parse_result = manyfx_parse_bitcrusher_params(
        argc,
        argv,
        &fx_params
    );
