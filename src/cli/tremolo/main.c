...
void print_usage() {
    printf("Usage: tremolo <input.wav> <output.wav> [options]\n\n");
    printf("Applies a tremolo effect (amplitude modulation)\n\n");
    printf("Options:\n");
    printf("  -h, --help, -?, --?  Show this help message and exit\n");
    printf("  --freq <float> - The frequency of the tremolo | default: 0.0\n");
    printf("  --depth <float> - The depth of the tremolo (0-1) | default: 0.0\n");
}
...
int main(
    ...
    tremolo_params_t fx_params;
    int parse_result = manyfx_parse_tremolo_params(
        argc,
        argv,
        &fx_params
    );
